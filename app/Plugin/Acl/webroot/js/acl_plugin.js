				...
				success: function (data, textStatus)
				{
					...
					for(var action in permissions)
					{
						...
						if(permissions[action] == true || permissions[action] == false)
						{
							...
							{
								icon_html = "<img src=\"" + app_root_url + "acl/img/design/tick.png?" + d.getTime() + "\" class=\"pointer\" alt=\"granted\" />";
								start_granted = true;
							}
							else
							{
								icon_html = "<img src=\"" + app_root_url + "acl/img/design/cross.png?" + d.getTime() + "\" class=\"pointer\" alt=\"denied\" />";
								start_granted = false;
							}
